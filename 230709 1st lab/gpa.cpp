...
int main()
{
    ...
    float gpa = ((theory_1 * theory_credit) + (theory_2 * theory_credit) + (theory_3 * theory_credit) + (theory_4 * theory_credit) + (lab_1 * lab_credit) + (lab_2 * lab_credit) + (lab_3 * lab_credit)) / total_credit;
